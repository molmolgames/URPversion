...
public class EnemyBossMoveTest : MonoBehaviour
{
    Rigidbody2D rigid;
    Animator animation;
    ...
    void FixedUpdate()
    {
        ...
        //    EnemyTurn();
        //}
        //Debug.DrawRay(rigid.position + Vector2.right * -10, Vector2.left, new Color(0, 1, 0);
        //RaycastHit2D raycast = Physics2D.Raycast(transform.position, transform.right * -10, 10, isLayer);
        //if (box.collision.gameObject.tag == "Player")
        //{
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(box.position, boxSize);
    }
}
